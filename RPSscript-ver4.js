...
let moves = 0;
    ...
    function gameEnd(){
        if(playerScore > computerScore){
            ...
            gameResult.textContent = 'Draw Match!'
        }
...
let playerPoint = document.createElement('div');
playerPoint.classList.add('playerPoint');
playerPoint.textContent =  'Player Score: ' + playerScore;
bodyContent.appendChild(playerPoint);

let computerPoint = document.createElement('div');
computerPoint.classList.add('computerPoint');
computerPoint.textContent = 'Computer Score: ' + computerScore;
bodyContent.appendChild(computerPoint);
*/ 
